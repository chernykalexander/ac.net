<?php
    ...
    switch ( $request_client[ manipulation ] ) {
        ...
        case 'insert':
            ...
            $mysqli->query(' insert into mgz_client(fio)
                            values(\'' . $request_client[ fio ] .  '\');');
        ...
        case 'update':
            ...
            $mysqli->query(' update mgz_client
                          set fio =  \'' . $request_client[ fio ] . '\'
        ...
        case 'delete':
            ...
            $mysqli->query(' delete from mgz_client where id = ' . $request_client[ id ] . '; ' );
