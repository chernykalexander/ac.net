<?php
    ...
    switch ( $request_client[ manipulation ] ) {
        ...
        case 'insert':
            ...
            $mysqli->query(' insert into mgz_check (id_pokupki, id_tovar, kolichestvo)
                            values('. $request_client[ id_pokupki ] .  ', '
                                    . $request_client[ id_tovar ] .  ' ,  '
                                    . $request_client[ kolichestvo ] . '); ');
        ...
        case 'delete':
            ...
            $mysqli->query(' delete from mgz_check where id = ' . $request_client[ id ] . '; ' );
